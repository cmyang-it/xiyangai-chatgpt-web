export default {
  common: {
    ...
    imageSizeNotEmpty: 'Hình ảnh kích thước không phải là trống rỗng',
  },
  chat: {
  ...
  setting: {
    ...
    theme: 'Giao diện',
    language: 'Ngôn ngữ',
		baseUrl: 'Địa chỉ mạng cơ bản.',
    timeout: 'Timeout',
    socks: 'Socks',
    httpsProxy: 'Ủy viên Https',
    toChat: 'Chuyển sang trò chuyện',
    toDrawing: 'Chuyển sang vẽ',
